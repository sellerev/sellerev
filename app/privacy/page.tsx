    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-gray max-w-none space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Amazon Data Access</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Data We Do NOT Collect</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Amazon API Access & Revocation</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              <li>
                <strong>Supabase:</strong> Authentication and database hosting. Supabase&apos;s privacy policy applies to data stored on their platform.
              </li>
              <li>
                <strong>OpenAI:</strong> AI-powered analysis and recommendations. Data sent to OpenAI is processed according to their privacy policy and API terms.
              </li>
            </ul>
            <p className="text-gray-700 leading-relaxed mt-4">
