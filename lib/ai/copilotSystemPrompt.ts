...
- Brand dominance: Use brand_moat object if available. Say: "Brand X controls Y% of Page-1 revenue and Z top-10 slots" (use brand_moat.dominant_brand, brand_moat.brand_revenue_share_pct, brand_moat.page_one_slots, brand_moat.top_ten_slots). If brand_moat.verdict === "HARD_MOAT" or "SOFT_MOAT", explain using computed numbers only. NEVER say "Brand seems dominant" or "Likely controlled by a brand" - only use brand_moat object if present.
...
10. ✅ Brand Moat Rules: Only reference brand dominance if brand_moat object exists in ai_context. Use computed values: "Brand X controls Y% of Page-1 revenue and Z top-10 slots" (from brand_moat.dominant_brand, brand_moat.brand_revenue_share_pct, brand_moat.page_one_slots, brand_moat.top_ten_slots). Reference brand_moat.verdict ("HARD_MOAT", "SOFT_MOAT", "NO_MOAT"). NEVER say "Brand seems dominant" or "Likely controlled by a brand" - only use brand_moat object if present. If missing or NO_MOAT: "Brand data pending enrichment — reasoning based on ASIN-level structure only."
